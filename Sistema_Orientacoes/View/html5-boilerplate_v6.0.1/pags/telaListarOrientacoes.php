...
<html class="no-js" lang="pt-br">
	<head>
		...
		<script src="../js/telaListarOrientacoes.js"></script>
		<!-- validacao senha -->
	...
	<body>
		...
		<div class="container">
			...
			<?php if(isset($professor)): ?>
				<label onclick="add();" style="cursor:pointer;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Adicionar Orientação</label>
			<?php endif; ?>
