...
<html class="no-js" lang="pt-br">
	<head>
		...
		<script src="../js/telaListarPesquisas.js"></script>
		<!-- validacao senha -->
	...
	<body>
		...
		<div class="container">
			...
			<div class="page-header">
				<h1>Listar Pesquisas</h1>
			</div>

			<?php if(isset($professor)): ?>
				<label onclick="add();" style="cursor:pointer;"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Adicionar Pesquisa</label>
			<?php endif; ?>
