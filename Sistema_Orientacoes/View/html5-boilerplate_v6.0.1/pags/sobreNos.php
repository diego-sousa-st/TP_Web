	...
	<div class="container">
	  ...
	  <div class="row col-md-12 text-center bg-warning shadowed-box bordered rounded">
		...
		<div class="row perfil-about">
		  ...
		  <section>
			<article>Amante de música, fissurado por otimizações de código mas ainda não aprendeu a gostar de café.</article>Começou a carreira em desenvolvimento em 2013 e atualmente está atuando como trainee na Technolog.<br>
			Frase: 'Quando eu fiz esse código, só eu e Deus entendíamos o que ele fazia. Agora, só Deus sabe.'
		  </section>
		</div>
	  </div>
	</div>
