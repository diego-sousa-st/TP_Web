	...
	<div class="container">
	  ...
	  <form id="formCadastroCurso" action="../../../Controller/CursoController.php" class="col-md-8" method="post">
		...
		<div class="form-group">
		  ...
		  <input id="codigo" type="number" name="codigo" min="0" required class="form-control">
		</div>
		<div class="form-group">
		  <label for="instituicao">Instituicao:</label>
		  <!-- preencer com options com valores do banco via js-->
		  <select id="instituicaos" name="instituicao" required class="form-control"></select>
		</div>
		<div class="form-group">
		  <label for="forma">Forma:</label>
		  <select id="forma" name="forma" required class="form-control">
		...
		<div class="form-group">
		  ...
		  <input id="siglaCurso" type="text" name="siglaCurso" maxlength="5" class="form-control">
		</div>
		<div class="form-group">
